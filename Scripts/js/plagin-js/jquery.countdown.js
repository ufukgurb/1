...
(function($){
	$.fn.countdown = function(options){
		...
		if(settings.show_day)
			dwcd_day = settings.wrapper('Hizmetlerimiz');
		if(settings.show_hour)
			dwcd_hour = settings.wrapper('Referanslar');
		if(settings.show_minute)
			dwcd_minute = settings.wrapper('Filomuz');
		if(settings.show_second)
			dwcd_second = settings.wrapper('Iletisim');
